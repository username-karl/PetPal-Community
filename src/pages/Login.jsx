            ...
            <div className="hidden lg:flex lg:w-5/12 bg-zinc-900 relative overflow-hidden flex-col justify-between p-12 text-white">
                ...
                <div className="z-10 relative">
                    ...
                    <p className="text-zinc-400 text-lg leading-relaxed max-w-sm">
                        Track your pet's health, connect with other owners, and manage everything in one place.
                    </p>
                    ...
                    <div className="mt-12 space-y-4">
                        <div className="flex items-center gap-4 text-sm text-zinc-300">
                            ...
                            <span>Smart health tracking & analytics</span>
                        </div>
                        <div className="flex items-center gap-4 text-sm text-zinc-300">
                            <div className="w-8 h-8 rounded-full bg-zinc-800 flex items-center justify-center border border-zinc-700">
                                <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                            </div>
                            <span>Community advice & support</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="absolute -left-24 -bottom-24 w-96 h-96 bg-emerald-500/10 rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="flex-1 flex flex-col justify-center items-center p-8 sm:p-12 lg:p-24 bg-white relative">
                ...
                <div className="w-full max-w-sm space-y-8">
                    <div className="space-y-2 text-center lg:text-left">
                        ...
                        <p className="text-zinc-500">
                            New to PetPal?{' '}
                            <Link to="/register" className="font-medium text-zinc-900 hover:text-zinc-700 hover:underline transition-all">
                                Create an account
                            </Link>
                        </p>
                    </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <button type="button" className="text-xs font-medium text-zinc-900 hover:text-zinc-700 hover:underline">
                                        Forgot details?
                                    </button>
                                </div>
                                <input
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-white px-2 text-zinc-400 font-medium tracking-wider">Or continue with</span>
                        </div>
                    </div>
                ...
                <div className="absolute bottom-6 left-0 w-full text-center">
                    <p className="text-xs text-zinc-400">
                        By signing in, you agree to our <a href="#" className="underline hover:text-zinc-600">Terms of Service</a> and <a href="#" className="underline hover:text-zinc-600">Privacy Policy</a>.
                    </p>
                </div>
            </div>
        </div>
